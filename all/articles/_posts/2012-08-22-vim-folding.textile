...
p(publish_date). 2012/08/22 19:00

p. 一直想修改一下vim的折叠的颜色， 表示太刺眼了， 折叠过后更看不懂代码. 最近终于下定了决心， 先贴一下效果图:
...
p. 注意这个方法是针对我的配色， 如果读者希望在自己的配色方案上修改也是同样的原理


p. 修改/usr/share/vim/vim73/colors/delek.vim
...
p. 折叠过后， 看代码就舒服多了， 再配上taglist, ctags, cscope等插件，打造一个自己的工作环境还是相当爽的.
