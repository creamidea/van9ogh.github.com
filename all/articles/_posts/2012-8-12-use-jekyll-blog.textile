...
<span class="attributed" style="font-size:small"><i>-- The Shawshank Redemption</i></span>
...
<p>关于语法高亮， 主要是使用javascript, 你也可以到google code上去下载, 这里直接使用了amazon上的js资源</p>
<a href="http://code.google.com/p/syntaxhighlighter/">syntaxhighlighter</a>
